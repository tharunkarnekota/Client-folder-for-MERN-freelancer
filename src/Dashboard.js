    ...
    return (
        <div>
            <nav className="navbar bg-dark">
                ...
                <Link to="/myprofile" className="btn btn-secondary" style={{"marginLeft":"990px"}} >My Profile</Link>&nbsp;&nbsp;
                <Link to="/login" className="btn btn-secondary" onClick={() => localStorage.removeItem('token')} >Logout</Link>&nbsp;&nbsp;
                
            </nav>
            <section className="container">
                <h1 className="large " style={{"color":"orange","marginTop":"20px"}}>Developers</h1>
                <p className="lead">
